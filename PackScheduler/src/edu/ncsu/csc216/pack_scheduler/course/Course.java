...
/**
 * Course keeps track of its name, title, section, credit hours, instructor’s
 * id, meeting days, start time and end time
 * 
...
//
	...
	/**
	 * Array of length 5 containing the Course name, section, title, roll, and
	 * meeting string.
	 * 
	...
	/**
	 * Array of length 7 containing the Course name, section, title, credits,
