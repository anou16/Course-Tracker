...
/**
 * Maintains a directory of Faculty for the university. Provides functionality
 * to add, remove, load, and save faculty records.
 * 
...
public class FacultyDirectory {
	...
	/**
	 * Constructs an empty FacultyDirectory. Initializes the facultyDirectory by
	 * calling newFacultyDirectory().
	 * 
	 * @author wangc
	 */
	...
	/**
	 * Loads faculty records from the specified file into the FacultyDirectory. This
	 * method supports [UC19].
	 * 
	...
	/**
	 * Saves the faculty directory to the specified file. This method supports
	 * [UC20].
	 * 
	 ...
	 * @return the Faculty object with the specified ID, or null if no match is
	 *         found
	 */
